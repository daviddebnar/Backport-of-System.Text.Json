...
namespace System
{
    internal static partial class SpanHelpers
    {
        ...
        internal readonly struct ComparerComparableC<T, TComparer> : IComparable<T>
            ...
            where T : class
        {
            ...
            public ComparerComparableC(T value, TComparer comparer)
            {
                _value = value;
                _comparer = comparer;
            }
        ...
        // Helper to allow sharing all code via IComparable<T> inlineable
        internal readonly struct ComparerComparableS<T, TComparer> : IComparable<T?>
            where TComparer : IComparer<T?>
            where T : struct
        {
            private readonly T _value;
            ...
            public ComparerComparableS(T value, TComparer comparer)
            {
                _value = value;
                _comparer = comparer;
            }
