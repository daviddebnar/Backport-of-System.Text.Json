...
namespace System
{
    internal static partial class SpanHelpers
    {
        ...
        public static unsafe void ClearWithoutReferences(ref byte b, uint byteLength)
        {
            ...
            if (((uint)Unsafe.AsPointer(ref b) & 3) != 0)
            {
                if (((uint)Unsafe.AsPointer(ref b) & 1) != 0)
                {
                    b = 0;
                    i += 1;
                    if (((uint)Unsafe.AsPointer(ref b) & 2) != 0)
                        goto IntAligned;
                }
                Unsafe.As<byte, short>(ref Unsafe.AddByteOffset<byte>(ref b, (IntPtr)i)) = 0;
                i += 2;
            }
            ...
            if ((((uint)Unsafe.AsPointer(ref b) - 1) & 4) == 0)
            {
                Unsafe.As<byte, int>(ref Unsafe.AddByteOffset<byte>(ref b, (IntPtr)i)) = 0;
                i += 4;
            }

            uint end = byteLength - 16;
...
#else
                Unsafe.As<byte, int>(ref Unsafe.AddByteOffset<byte>(ref b, (IntPtr)i)) = 0;
                Unsafe.As<byte, int>(ref Unsafe.AddByteOffset<byte>(ref b, (IntPtr)(i + 4))) = 0;
                Unsafe.As<byte, int>(ref Unsafe.AddByteOffset<byte>(ref b, (IntPtr)(i + 8))) = 0;
                Unsafe.As<byte, int>(ref Unsafe.AddByteOffset<byte>(ref b, (IntPtr)(i + 12))) = 0;
#endif
            ...
            if ((byteLength & 1) != 0)
            {
                Unsafe.AddByteOffset<byte>(ref b, (IntPtr)i) = 0;
