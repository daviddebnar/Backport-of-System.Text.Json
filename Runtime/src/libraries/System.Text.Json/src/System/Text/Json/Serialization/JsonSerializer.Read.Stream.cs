...
namespace System.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        */
        ...
        /// </exception>
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        public static TValue? DeserializeC<TValue>(
            Stream utf8Json,
            JsonSerializerOptions? options = null) where TValue : class
        {
            ...
            return ReadAllUsingOptionsC<TValue>(utf8Json, typeof(TValue), options);
        }
        ...
        /// </exception>
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        public static TValue? DeserializeS<TValue>(
            Stream utf8Json,
            JsonSerializerOptions? options = null) where TValue : struct
        {
            ...
            return ReadAllUsingOptionsS<TValue>(utf8Json, typeof(TValue), options);
        }
        ...
        */
            ...
            JsonSerializerOptions? options = null)
        {
            ...
            return ReadAllUsingOptionsC<object>(utf8Json, returnType, options);
        }
        ...
        */
        ...
        public static TValue? DeserializeC<TValue>(
            Stream utf8Json,
            JsonTypeInfoC<TValue> jsonTypeInfo) where TValue : class
        {
            if (utf8Json == null)
            {
                throw new ArgumentNullException(nameof(utf8Json));
            ...
            return ReadAllC<TValue>(utf8Json, jsonTypeInfo);
        }
        ...
        public static TValue? DeserializeS<TValue>(
            Stream utf8Json,
            JsonTypeInfoS<TValue> jsonTypeInfo) where TValue : struct
        {
            if (utf8Json == null)
            {
                throw new ArgumentNullException(nameof(utf8Json));
            ...
            return ReadAllS<TValue>(utf8Json, jsonTypeInfo);
        }
        ...
        */
            ...
            JsonSerializerContext context)
        {
            ...
            return ReadAllC<object>(utf8Json, GetTypeInfo(context, returnType));
        }
        ...
        */
        ...
        internal static TValue? ReadAllC<TValue>(
            Stream utf8Json,
            JsonTypeInfo jsonTypeInfo) where TValue : class
        {
            JsonSerializerOptions options = jsonTypeInfo.Options;
            var bufferState = new ReadBufferState(options.DefaultBufferSize);
            ReadStack readStack = default;
            ...
            try
            {
                while (true)
                {
                    ...
                    TValue value = ContinueDeserializeC<TValue>(ref bufferState, ref jsonReaderState, ref readStack, converter, options);
        ...
        internal static TValue? ReadAllS<TValue>(
            Stream utf8Json,
            JsonTypeInfo jsonTypeInfo) where TValue : struct
        {
            JsonSerializerOptions options = jsonTypeInfo.Options;
            var bufferState = new ReadBufferState(options.DefaultBufferSize);
            ReadStack readStack = default;
            ...
            try
            {
                ...
                {
                    bufferState = ReadFromStream(utf8Json, bufferState);
                    TValue value = ContinueDeserializeS<TValue>(ref bufferState, ref jsonReaderState, ref readStack, converter, options);
        ...
        */
        ...
        internal static TValue ContinueDeserializeC<TValue>(
            ref ReadBufferState bufferState,
            ref JsonReaderState jsonReaderState,
            ref ReadStack readStack,
            JsonConverter converter,
            JsonSerializerOptions options) where TValue : class
        {
        ...
        internal static TValue ContinueDeserializeS<TValue>(
            ref ReadBufferState bufferState,
            ref JsonReaderState jsonReaderState,
            ref ReadStack readStack,
            JsonConverter converter,
            JsonSerializerOptions options) where TValue : struct
        {
            if (bufferState.BytesInBuffer > bufferState.ClearMax)
            {
                bufferState.ClearMax = bufferState.BytesInBuffer;
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        private static TValue? ReadAllUsingOptionsC<TValue>(
            Stream utf8Json,
            Type returnType,
            JsonSerializerOptions? options) where TValue : class
        {
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        private static TValue? ReadAllUsingOptionsS<TValue>(
            Stream utf8Json,
            Type returnType,
            JsonSerializerOptions? options) where TValue : struct
        {
        ...
        private static TValue ReadCoreC<TValue>(
            ref JsonReaderState readerState,
            bool isFinalBlock,
            ReadOnlySpan<byte> buffer,
            JsonSerializerOptions options,
            ref ReadStack state,
            JsonConverter converterBase) where TValue : class
        {
            ...
            TValue? value = ReadCoreC<TValue>(converterBase, ref reader, options, ref state);
            readerState = reader.CurrentState;
            return value!;
        }
        

        private static TValue ReadCoreS<TValue>(
            ref JsonReaderState readerState,
            bool isFinalBlock,
            ReadOnlySpan<byte> buffer,
            JsonSerializerOptions options,
            ref ReadStack state,
            JsonConverter converterBase) where TValue : struct
        {
            var reader = new Utf8JsonReader(buffer, isFinalBlock, readerState);
            ...
            TValue? value = ReadCoreS<TValue>(converterBase, ref reader, options, ref state);
            readerState = reader.CurrentState;
            return value!.Value;
        }
    }
