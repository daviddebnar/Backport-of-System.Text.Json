...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    internal sealed class JsonPropertyInfoC<T> : JsonPropertyInfo where T : class
    {
        /// <summary>
        ...
        public JsonConverterC<T> Converter { get; internal set; } = null!;
        ...
        internal void InitializeForSourceGen(JsonSerializerOptions options, JsonPropertyInfoValuesC<T> propertyInfo)
        {
            Options = options;
        ...
        internal override JsonConverter ConverterBase
        {
            ...
            set
            {
                Debug.Assert(value is JsonConverterC<T>);
                Converter = (JsonConverterC<T>)value;
            }
        }
