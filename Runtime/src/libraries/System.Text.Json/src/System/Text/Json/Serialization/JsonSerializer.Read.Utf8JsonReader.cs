...
namespace System.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        public static TValue? DeserializeC<TValue>(ref Utf8JsonReader reader, JsonSerializerOptions? options = null) where TValue : class
        {
            JsonTypeInfo jsonTypeInfo = GetTypeInfo(options, typeof(TValue));
            return ReadC<TValue>(ref reader, jsonTypeInfo);
        }
        ...
        /// </remarks>
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        public static TValue? DeserializeS<TValue>(ref Utf8JsonReader reader, JsonSerializerOptions? options = null) where TValue : struct
        {
            JsonTypeInfo jsonTypeInfo = GetTypeInfo(options, typeof(TValue));
            return ReadS<TValue>(ref reader, jsonTypeInfo);
        }
        ...
        public static object? Deserialize(ref Utf8JsonReader reader, Type returnType, JsonSerializerOptions? options = null)
        {
            ...
            return ReadC<object?>(ref reader, jsonTypeInfo);
        }
        ...
        ///   </para>
        /// </remarks>
        public static TValue? DeserializeC<TValue>(ref Utf8JsonReader reader, JsonTypeInfoC<TValue> jsonTypeInfo) where TValue : class
        {
        ...
        ///   </para>
        /// </remarks>
        public static TValue? DeserializeS<TValue>(ref Utf8JsonReader reader, JsonTypeInfoS<TValue> jsonTypeInfo) where TValue : struct
        {
            if (jsonTypeInfo == null)
            {
                throw new ArgumentNullException(nameof(jsonTypeInfo));
        ...
        public static object? Deserialize(ref Utf8JsonReader reader, Type returnType, JsonSerializerContext context)
        {
            ...
            return ReadC<object>(ref reader, GetTypeInfo(context, returnType));
        }

        private static TValue? ReadC<TValue>(ref Utf8JsonReader reader, JsonTypeInfo jsonTypeInfo) where TValue : class
        {
            ...
            try
            {
                ...
                TValue? value = ReadCoreC<TValue>(jsonConverter, ref newReader, jsonTypeInfo.Options, ref state);
        ...
        private static TValue? ReadS<TValue>(ref Utf8JsonReader reader, JsonTypeInfo jsonTypeInfo) where TValue : struct
        {
            ReadStack state = default;
            state.Initialize(jsonTypeInfo);
            ...
            try
            {
                ...
                JsonConverter jsonConverter = state.Current.JsonPropertyInfo!.ConverterBase;
                TValue? value = ReadCoreS<TValue>(jsonConverter, ref newReader, jsonTypeInfo.Options, ref state);
