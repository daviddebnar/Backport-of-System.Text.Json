...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    /// </summary>
    /// <typeparamref name="T"/> is the <see cref="JsonConverterC{T}.TypeToConvert"/> for either the property's converter,
    /// or a type's converter, if the current instance is a <see cref="JsonTypeInfo.PropertyInfoForTypeInfo"/>.
    internal sealed class JsonPropertyInfoS<T> : JsonPropertyInfo where T : struct
    {
        /// <summary>
        ...
        public JsonConverterS<T> Converter { get; internal set; } = null!;
        ...
        internal void InitializeForSourceGen(JsonSerializerOptions options, JsonPropertyInfoValuesS<T> propertyInfo)
        {
            Options = options;
        ...
        internal override JsonConverter ConverterBase
        {
            ...
            set
            {
                Debug.Assert(value is JsonConverterS<T>);
                Converter = (JsonConverterS<T>)value;
            }
        }
