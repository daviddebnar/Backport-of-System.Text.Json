...
namespace System.Text.Json
{
    ...
    /// </summary>
    internal partial class JsonPropertyDictionaryS<T> where T : struct
    {
        ...
        public JsonPropertyDictionaryS(bool caseInsensitive)
        {
        ...
        public JsonPropertyDictionaryS(bool caseInsensitive, int capacity)
        {
            _stringComparer = caseInsensitive ? StringComparer.OrdinalIgnoreCase : StringComparer.Ordinal;
