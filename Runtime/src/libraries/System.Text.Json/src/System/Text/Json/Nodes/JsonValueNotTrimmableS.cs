...
namespace System.Text.Json.Nodes
{
    ...
    /// </summary>
    internal sealed partial class JsonValueNotTrimmableS<TValue> : JsonValueS<TValue> where TValue : struct
    {
        [RequiresUnreferencedCode(JsonSerializer.SerializationUnreferencedCodeMessage)]
        public JsonValueNotTrimmableS(TValue value, JsonNodeOptions? options = null) : base(value, options) { }
