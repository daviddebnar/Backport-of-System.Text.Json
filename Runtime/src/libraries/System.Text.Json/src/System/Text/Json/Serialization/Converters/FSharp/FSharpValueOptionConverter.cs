...
namespace System.Text.Json.Serialization.Converters
{
    ...
    internal sealed class FSharpValueOptionConverter<TValueOption, TElement> : JsonConverterS<TValueOption>
        ...
        where TElement : struct
    {
        ...
        private readonly JsonConverterS<TElement> _elementConverter;
        ...
        public FSharpValueOptionConverter(JsonConverterS<TElement> elementConverter)
        {
            _elementConverter = elementConverter;
            _optionValueGetter = FSharpCoreReflectionProxy.Instance.CreateFSharpValueOptionValueGetter<TValueOption, TElement>();
            _optionConstructor = FSharpCoreReflectionProxy.Instance.CreateFSharpValueOptionSomeConstructorS<TValueOption, TElement>();
