...
namespace System.Text.Json.Nodes
{
    ...
    [DebuggerTypeProxy(typeof(JsonValueS<>.DebugView))]
    internal abstract partial class JsonValueS<TValue> : JsonValue where TValue : struct
    {
        public readonly TValue _value; // keep as a field for direct access to avoid copies

        public JsonValueS(TValue value, JsonNodeOptions? options = null) : base(options)
        {
        ...
        private class DebugView
        {
            ...
            public JsonValueS<TValue> _node;

            public DebugView(JsonValueS<TValue> node)
            {
                _node = node;
            }
