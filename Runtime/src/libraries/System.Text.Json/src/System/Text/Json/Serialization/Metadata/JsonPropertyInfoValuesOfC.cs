...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    public sealed class JsonPropertyInfoValuesC<T> where T : class
    {
        /// <summary>
        ...
        /// </summary>
        public JsonConverterC<T>? Converter { get; }
        ...
        public JsonPropertyInfoValuesC(
            bool isProperty,
            bool isPublic,
            bool isVirtual,
            Type declaringType,
            JsonTypeInfo propertyTypeInfo,
            JsonConverterC<T>? converter,
