...
namespace System.Text.Json.Nodes
{
    ...
    public sealed partial class JsonArray : JsonNode
    {
        ...
        public void AddC<T>(T? value) where T : class
        {
            if (value == null)
            {
                Add(null);
            ...
            else
            {
                ...
                if (jNode == null)
                {
                    jNode = new JsonValueNotTrimmableC<T>(value);
                }
        ...
        /// </param>
        [RequiresUnreferencedCode(JsonValue.CreateUnreferencedCodeMessage)]
        public void AddS<T>(T value) where T : struct
        {
            /*if (value == null)
            {
                Add(null);
            ...
            else*/
            {
                ...
                if (jNode == null)
                {
                    jNode = new JsonValueNotTrimmableS<T>(value);
                }
