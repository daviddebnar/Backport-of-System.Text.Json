...
namespace System.Text.Json.Serialization
{
    ...
    /// </summary>
    internal abstract class JsonDictionaryConverterC<TDictionary> : JsonResumableConverterC<TDictionary>
    ...
    /// Base class for dictionary converters such as IDictionary, Hashtable, Dictionary{,} IDictionary{,} and SortedList.
    /// </summary>
    internal abstract class JsonDictionaryConverterC<TDictionary, TKey, TValue> : JsonDictionaryConverterC<TDictionary>
        where TDictionary : class
        where TKey : class
        where TValue : class
    {
        ...
        protected JsonConverterC<TKey>? _keyConverter;
        protected JsonConverterC<TValue>? _valueConverter;

        protected static JsonConverterC<T> GetConverter<T>(JsonTypeInfo typeInfo) where T : class
        {
            JsonConverterC<T> converter = (JsonConverterC<T>)typeInfo.PropertyInfoForTypeInfo.ConverterBase;
