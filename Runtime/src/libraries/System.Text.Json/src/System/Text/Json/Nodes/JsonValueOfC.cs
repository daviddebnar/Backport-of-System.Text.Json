...
namespace System.Text.Json.Nodes
{
    ...
    [DebuggerTypeProxy(typeof(JsonValueC<>.DebugView))]
    internal abstract partial class JsonValueC<TValue> : JsonValue where TValue : class
    {
        public readonly TValue _value; // keep as a field for direct access to avoid copies

        public JsonValueC(TValue value, JsonNodeOptions? options = null) : base(options)
        {
        ...
        private class DebugView
        {
            ...
            public JsonValueC<TValue> _node;

            public DebugView(JsonValueC<TValue> node)
            {
                _node = node;
            }
