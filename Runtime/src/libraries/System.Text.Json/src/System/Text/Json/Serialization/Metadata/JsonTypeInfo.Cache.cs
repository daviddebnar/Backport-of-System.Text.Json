...
namespace System.Text.Json.Serialization.Metadata
{
    public partial class JsonTypeInfo
    {
        ...
        internal JsonPropertyDictionaryC<JsonParameterInfo>? ParameterCache;

        // All of the serializable properties on a POCO (except the optional extension property) keyed on property name.
        internal JsonPropertyDictionaryC<JsonPropertyInfo>? PropertyCache;
        ...
        internal void InitializePropCache()
        {
            ...
            JsonPropertyDictionaryC<JsonPropertyInfo> propertyCache = new JsonPropertyDictionaryC<JsonPropertyInfo>(Options.PropertyNameCaseInsensitive, array.Length);
