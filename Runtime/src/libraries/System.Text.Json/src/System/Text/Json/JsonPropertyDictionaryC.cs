...
namespace System.Text.Json
{
    ...
    /// </summary>
    internal partial class JsonPropertyDictionaryC<T> where T : class
    {
        ...
        public JsonPropertyDictionaryC(bool caseInsensitive)
        {
        ...
        public JsonPropertyDictionaryC(bool caseInsensitive, int capacity)
        {
            _stringComparer = caseInsensitive ? StringComparer.OrdinalIgnoreCase : StringComparer.Ordinal;
