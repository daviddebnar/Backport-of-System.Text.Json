...
namespace System.Text.Json.Serialization
{
    ...
    /// </summary>
    internal abstract class JsonCollectionConverterC<TCollection, TElement> : JsonResumableConverterC<TCollection>
        ...
        where TElement : class
    {
        ...
        protected static JsonConverterC<TElement> GetElementConverter(JsonTypeInfo elementTypeInfo)
        {
            JsonConverterC<TElement> converter = (JsonConverterC<TElement>)elementTypeInfo.PropertyInfoForTypeInfo.ConverterBase;
            Debug.Assert(converter != null); // It should not be possible to have a null converter at this point.

            return converter;
        }

        protected static JsonConverterC<TElement> GetElementConverter(ref WriteStack state)
        {
            JsonConverterC<TElement> converter = (JsonConverterC<TElement>)state.Current.DeclaredJsonPropertyInfo!.ConverterBase;
            Debug.Assert(converter != null); // It should not be possible to have a null converter at this point.
            ...
            [MaybeNullWhen(false)] out TCollection value)
        {
            ...
            if (state.UseFastPath)
            {
                ...
                JsonConverterC<TElement> elementConverter = GetElementConverter(elementTypeInfo);
