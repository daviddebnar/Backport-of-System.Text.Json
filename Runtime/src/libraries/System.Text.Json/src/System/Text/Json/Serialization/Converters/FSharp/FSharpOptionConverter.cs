...
namespace System.Text.Json.Serialization.Converters
{
    ...
    internal sealed class FSharpOptionConverter<TOption, TElement> : JsonConverterC<TOption>
        where TOption : class
        where TElement : class
    {
        ...
        private readonly JsonConverterC<TElement> _elementConverter;
        ...
        public FSharpOptionConverter(JsonConverterC<TElement> elementConverter)
        {
