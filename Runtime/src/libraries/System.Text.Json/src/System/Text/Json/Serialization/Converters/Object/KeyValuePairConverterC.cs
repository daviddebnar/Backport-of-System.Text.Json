...
{
    internal sealed class KeyValuePairConverterC<TKey, TValue> :
        SmallObjectWithParameterizedConstructorConverterC<KeyValuePair<TKey, TValue>, TKey, TValue, object, object>
        where TKey : class
        where TValue : class
    {
