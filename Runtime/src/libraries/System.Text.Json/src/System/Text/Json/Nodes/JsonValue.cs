...
namespace System.Text.Json.Nodes
{
    ...
    public abstract partial class JsonValue : JsonNode
    {
        ...
        public static JsonValue? CreateC<T>(T? value, JsonNodeOptions? options = null) where T : class
        {
            if (value == null)
            {
                return null;
            ...
            if (value is JsonElement element)
            {
                ...
                return new JsonValueTrimmableS<JsonElement>(element, JsonMetadataServices.JsonElementConverter, options);
            }

            return new JsonValueNotTrimmableC<T>(value, options);
        }
        ...
        /// <returns>The new instance of the <see cref="JsonValue"/> class that contains the specified value.</returns>
        [RequiresUnreferencedCode(CreateUnreferencedCodeMessage + " Use the overload that takes a JsonTypeInfo, or make sure all of the required types are preserved.")]
        public static JsonValue? CreateS<T>(T? value, JsonNodeOptions? options = null) where T : struct
        {
            ...
            return new JsonValueNotTrimmableS<T>(validValue, options);
        }
        ...
        /// <param name="options">Options to control the behavior.</param>
        /// <returns>The new instance of the <see cref="JsonValue"/> class that contains the specified value.</returns>
        public static JsonValue? CreateC<T>(T? value, JsonTypeInfoC<T> jsonTypeInfo, JsonNodeOptions? options = null) where T : class
        {
            ...
            return new JsonValueTrimmableC<T>(value, jsonTypeInfo, options);
        }
        ...
        /// <param name="options">Options to control the behavior.</param>
        /// <returns>The new instance of the <see cref="JsonValue"/> class that contains the specified value.</returns>
        public static JsonValue? CreateS<T>(T? value, JsonTypeInfoS<T> jsonTypeInfo, JsonNodeOptions? options = null) where T : struct
        {
            if (jsonTypeInfo == null)
            {
                throw new ArgumentNullException(nameof(jsonTypeInfo));
            ...
            return new JsonValueTrimmableS<T>(validValue, jsonTypeInfo, options);
        }
        ...
        public abstract bool TryGetValue<T>([NotNullWhen(true)] out T? value) where T : class;
        ...
        /// <param name="value">When this method returns, contains the parsed value.</param>
        /// <returns><see langword="true"/> if the value can be successfully obtained; otherwise, <see langword="false"/>.</returns>
        public abstract bool TryGetValue<T>([NotNullWhen(true)] out T? value) where T : struct;
