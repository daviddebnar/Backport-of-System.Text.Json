...
namespace System.Text.Json.Serialization.Converters
{
    ...
    /// </summary>
    internal sealed class ArrayConverter<TCollection, TElement> : IEnumerableDefaultConverterC<TElement[], TElement> 
        where TElement : class
    {
        ...
        protected override bool OnWriteResume(Utf8JsonWriter writer, TElement[] array, JsonSerializerOptions options, ref WriteStack state)
        {
            ...
            JsonConverterC<TElement> elementConverter = GetElementConverter(ref state);
