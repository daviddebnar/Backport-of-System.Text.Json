...
namespace System.Text.Json.Serialization.Converters
{
    ...
    /// </summary>
    internal class SmallObjectWithParameterizedConstructorConverterS<T, TArg0, TArg1, TArg2, TArg3> : ObjectWithParameterizedConstructorConverterS<T> 
        where T : struct
        where TArg0 : struct
        where TArg1 : struct
        where TArg2 : class
        where TArg3 : class
    {
            ...
            JsonParameterInfo jsonParameterInfo)
        {
            ...
            {
                case 0:
                    success = TryReadS<TArg0>(ref state, ref reader, jsonParameterInfo, out arguments.Arg0);
                    break;
                case 1:
                    success = TryReadS<TArg1>(ref state, ref reader, jsonParameterInfo, out arguments.Arg1);
                    break;
                case 2:
                    success = TryReadC<TArg2>(ref state, ref reader, jsonParameterInfo, out arguments.Arg2);
                    break;
                case 3:
                    success = TryReadC<TArg3>(ref state, ref reader, jsonParameterInfo, out arguments.Arg3);
                    break;
                default:
        ...
        private bool TryReadC<TArg>(
            ref ReadStack state,
            ref Utf8JsonReader reader,
            JsonParameterInfo jsonParameterInfo,
            out TArg arg) where TArg : class
        {
            ...
            var converter = (JsonConverterC<TArg>)jsonParameterInfo.ConverterBase;
        ...
        private bool TryReadS<TArg>(
            ref ReadStack state,
            ref Utf8JsonReader reader,
            JsonParameterInfo jsonParameterInfo,
            out TArg arg) where TArg : struct
        {
            Debug.Assert(jsonParameterInfo.ShouldDeserialize);
            Debug.Assert(jsonParameterInfo.Options != null);

            var info = (JsonParameterInfo<TArg>)jsonParameterInfo;
            var converter = (JsonConverterS<TArg>)jsonParameterInfo.ConverterBase;
