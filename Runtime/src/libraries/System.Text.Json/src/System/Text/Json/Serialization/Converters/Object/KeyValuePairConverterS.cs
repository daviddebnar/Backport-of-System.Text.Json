...
{
    internal sealed class KeyValuePairConverterS<TKey, TValue> :
        SmallObjectWithParameterizedConstructorConverterS<KeyValuePair<TKey, TValue>, TKey, TValue, object, object>
        where TKey : struct
        where TValue : struct
    {
