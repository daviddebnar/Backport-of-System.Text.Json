...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    public abstract class JsonPropertyInfo
    {
        ...
        {
            JsonPropertyInfo info = new JsonPropertyInfoC<object>();
        ...
        {
            JsonPropertyInfo jsonPropertyInfo = new JsonPropertyInfoS<sbyte>();
...
#pragma warning restore SYSLIB0020
            ...
            ref Utf8JsonReader reader)
        {
            ...
            if (propValue is IDictionary<string, object?> dictionaryObjectValue)
            {
                ...
                {
                    JsonConverterC<object> converter = (JsonConverterC<object>)GetDictionaryValueConverter(JsonTypeInfo.ObjectType);
            ...
            else if (propValue is IDictionary<string, JsonElement> dictionaryElementValue)
            {
                ...
                JsonConverterS<JsonElement> converter = (JsonConverterS<JsonElement>)GetDictionaryValueConverter(elementType);
                JsonElement? value = converter.Read(ref reader, elementType, Options);
                dictionaryElementValue[state.Current.JsonPropertyNameAsString!] = value!.Value;
            }
            else
            {
        ...
        internal bool ReadJsonExtensionDataValue(ref ReadStack state, ref Utf8JsonReader reader, out object? value)
        {
            ...
            JsonConverterS<JsonElement> converter = (JsonConverterS<JsonElement>)Options.GetConverterInternal(typeof(JsonElement));
