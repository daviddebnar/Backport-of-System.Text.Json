...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    public partial class JsonTypeInfo
    {
                ...
                case ConverterStrategy.Object:
                    {
                        ...
                        PropertyCache = new JsonPropertyDictionaryC<JsonPropertyInfo>(Options.PropertyNameCaseInsensitive, capacity: properties.Length);
        ...
        private void CacheMember(JsonPropertyInfo jsonPropertyInfo, JsonPropertyDictionaryC<JsonPropertyInfo>? propertyCache, ref Dictionary<string, JsonPropertyInfo>? ignoredMembers)
        {
        ...
        {
            var parameterCache = new JsonPropertyDictionaryC<JsonParameterInfo>(Options.PropertyNameCaseInsensitive, jsonParameters.Length);
            ...
            foreach (KeyValuePair<string, JsonPropertyInfo?> kvp in PropertyCache.List)
            {
                ...
                ParameterLookupKey key = new ParameterLookupKey(propertyName, jsonProperty.DeclaredPropertyType);
                ParameterLookupValue value = new ParameterLookupValue(jsonProperty);
            ...
            {
                ParameterLookupKey paramToCheck = new ParameterLookupKey(parameterInfo.Name, parameterInfo.ParameterType);
        ...
        private static JsonParameterInfoValues[] GetParameterInfoArray(ParameterInfo[] parameters)
        {
            ...
            for (int i = 0; i < parameterCount; i++)
            {
                ...
                JsonParameterInfoValues jsonInfo = new JsonParameterInfoValues(
