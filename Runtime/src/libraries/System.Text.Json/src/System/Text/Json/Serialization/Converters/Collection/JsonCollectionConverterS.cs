...
namespace System.Text.Json.Serialization
{
    ...
    /// </summary>
    internal abstract class JsonCollectionConverterS<TCollection, TElement> : JsonResumableConverterS<TCollection>
        ...
        where TElement : struct
    {
        ...
        protected static JsonConverterS<TElement> GetElementConverter(JsonTypeInfo elementTypeInfo)
        {
            JsonConverterS<TElement> converter = (JsonConverterS<TElement>)elementTypeInfo.PropertyInfoForTypeInfo.ConverterBase;
            Debug.Assert(converter != null); // It should not be possible to have a null converter at this point.

            return converter;
        }

        protected static JsonConverterS<TElement> GetElementConverter(ref WriteStack state)
        {
            JsonConverterS<TElement> converter = (JsonConverterS<TElement>)state.Current.DeclaredJsonPropertyInfo!.ConverterBase;
            Debug.Assert(converter != null); // It should not be possible to have a null converter at this point.
            ...
            [MaybeNullWhen(false)] out TCollection value)
        {
            ...
            if (state.UseFastPath)
            {
                ...
                JsonConverterS<TElement> elementConverter = GetElementConverter(elementTypeInfo);
