...
namespace System.Text.Json.Serialization.Converters
{
    ...
    /// </summary>
    internal sealed class JsonNodeConverter : JsonConverterC<JsonNode>
    {
        ...
        public static JsonNode? Create(JsonElement element, JsonNodeOptions? options)
        {
            ...
            switch (element.ValueKind)
            {
                ...
                case JsonValueKind.Array:
                    ...
                    break;
                default:
                    node = new JsonValueTrimmableS<JsonElement>(element, JsonMetadataServices.JsonElementConverter, options);
                    break;
            }
