        ...
        private bool TryFindNextKeyOccurrence(string key, int startIndex, out int keyIndex)
        {
            ...
            while (true)
            {
                ...
                // Check If the match is at the beginning of the string, or is preceded by a newline.
                    ...
                    || (keyIndex >= Environment.NewLine.Length && _buffer.AsSpan(keyIndex - Environment.NewLine.Length, Environment.NewLine.Length).SequenceEqual(Environment.NewLine.AsSpan())))
                {
